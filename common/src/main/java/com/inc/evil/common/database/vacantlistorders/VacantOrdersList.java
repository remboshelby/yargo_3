...
public class VacantOrdersList {
    @PrimaryKey(autoGenerate = true)
    private long idVacantOrder;

    @Nullable
    private long idVacanBackend;
    @Nullable
    ...
    public long getIdVacantOrder() {
        return idVacantOrder;
    }

    public void setIdVacantOrder(long idVacantOrder) {
        this.idVacantOrder = idVacantOrder;
    }

    public long getIdVacanBackend() {
        return idVacanBackend;
    }

    public void setIdVacanBackend(long idVacanBackend) {
        this.idVacanBackend = idVacanBackend;
    }
